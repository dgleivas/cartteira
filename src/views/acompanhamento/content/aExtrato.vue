      ...
      <table class="table table-striped table-hover">
        <thead>
          <tr class="table-dark text-center">
            <th class="col text-left" width="7%">Dia</th>
            <th class="col">Tipo</th>
            <th class="col" width="10%">Codigo</th>
            <th class="col text-left">Empresa</th>
            <th class="col" width="7%">Operação</th>
            <th class="col" width="9%">Qtde</th>
            <th class="col" width="10%">Preço Médio</th>
            <th class="col" width="10%">Valor total</th>
            <th class="col" width="3%"></th>
          </tr>
        </thead>
        <tbody>
